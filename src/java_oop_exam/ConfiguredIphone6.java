...
public class ConfiguredIphone6 extends Iphone6 {
	...
	/*
	 * Final type method can not be override from Iphone6 public final int
	 * materials(int ramPrice, int cameraPrice,int phonePrice,int headPhonePrice,int
	 * dataPrice) {// Final type int total = ramPrice + cameraPrice + phonePrice +
	 * headPhonePrice + dataPrice; System.out.println("Final method Total price is:"
	 * + total); return total;
	 */
}
