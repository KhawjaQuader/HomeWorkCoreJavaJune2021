...
/* 1 Create a package name "hw5Q3variableAndMethod" in your HW project.Inside the package, 
 * 2 Create a class "Computer". 
 * 3 Declare some variable -- Brand, Model, Operating system, price, madeInUSA, grade (as char). 
 * 4 Implement a method inside the class -- "configuration" and use
 * 5 only one System.out.println(). Use the variables inside sysout. 
  ...
  10 I want second outcome in console for your configuration. So, Total 2 outcome is expecting from the test class. Organize your code. 
  11 Push in the github. Paste your github link below. (Please paste the whole question inside the multiple line comments between package and class)
 */
