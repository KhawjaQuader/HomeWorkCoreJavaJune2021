...
/*
 * (Paste the complete question between package and class by multiple line comments.). Create a package name "hw6Q3Inheritance" in HW project. Inside the package, 
 ...
 * i) Create another class "Cobra". Implement a method inside the class -- cobraInfo and System.out.println("This method is from Cobra Class"). Now create a class "TestAnimal". Under the main method create an object from each class and call their own method by their own object. 
 * 
