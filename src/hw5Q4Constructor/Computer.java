...
public class Computer {// 2 Here left side of curly braces class name computer created
	...
	public Computer() {// 4 default constructor declared
		System.out.println(" This is default constructor");// 1st out come
	}
	...
	public Computer(String Brand,String Model,String OperatingSystem,int price,boolean madeInUSA,char grade) {
		...
		System.out.println(" Brand: " + Brand + ", Model: " + Model + ", Operating System: " + OperatingSystem + ", Price: " + price + " and Made in USA?: " + madeInUSA + ", Grade: " + grade);
