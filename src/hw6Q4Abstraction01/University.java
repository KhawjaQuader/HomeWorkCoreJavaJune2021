 ...
 *  
 * Now, i) Can you create a Constructor inside the interface? If yes, create default Constructor on each interface. If no, comment out the 'created constructor' and answer why not? Now, answer how many keywords are used for the inheritance for Interface? Can an interface inherit other Interface, or a regular class or abstract class? How many inheritance is possible? Use the Interface -- "University" to answer my questions. ii) You have 2 abstract class name --MedicalSchool, EngineeringSchool already.
 *   
...
public interface University {
	...
	// More then one inherit is possible in Interface
