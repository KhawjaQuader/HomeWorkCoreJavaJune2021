...
*Use the above regular Classes to answer my questions. You don't need to execute anything as the main method is absent. 
...
public class RockefellerUniversity extends EngineeringSchool implements AeronauticalSchool {//Regular Class
